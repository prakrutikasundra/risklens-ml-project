...
def apply_theme() -> None:
    ...
    <style>
      ...
      .stApp:has(.theme-dark) div[data-testid="stHorizontalBlock"]:has(.brand) div[role="radiogroup"] label{{color:var(--rl-nav-text)}}
      .stApp:has(.theme-dark) div[data-testid="stHorizontalBlock"]:has(.brand) div[role="radiogroup"] label:hover{{background:var(--rl-nav-hover);color:#93c5fd}}
      .stApp:has(.theme-dark) div[data-testid="stHorizontalBlock"]:has(.brand) div[role="radiogroup"] label:has(input:checked){{background:var(--rl-nav-active);color:#bfdbfe}}
...
<style>
  ...
  div[data-testid="stHorizontalBlock"]:has(.brand) div[role="radiogroup"]{display:flex;justify-content:flex-end;align-items:center;gap:.25rem;width:100%;padding:0;margin:0}
  div[data-testid="stHorizontalBlock"]:has(.brand) div[role="radiogroup"] label{position:relative;display:flex!important;align-items:center;justify-content:center;min-height:38px;margin:0!important;padding:.45rem .75rem!important;border-radius:9px;color:#475569;font-size:.9rem;font-weight:650;cursor:pointer;transition:background .18s ease,color .18s ease,transform .18s ease}
  div[data-testid="stHorizontalBlock"]:has(.brand) div[role="radiogroup"] label:hover{background:#eff6ff;color:#1d4ed8;transform:translateY(-1px)}
